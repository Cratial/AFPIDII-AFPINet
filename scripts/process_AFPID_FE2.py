...
afpid_dataset_dir = "../data/acoustic_footstep/AFPID_FE2"
...
for i in range(13):
    ...
    for j in range(len(audio_dir)):
        ...
        for k in range(4, len(fse_sep_tim_vec) - 2):
            ...
            fname_wave = os.path.join(wave_cachedir, f"afpid_fe2_s{sample_fname}_waveform_{sample_num}.npy")
            fname_hcraft = os.path.join(hcraft_cachedir, f"afpid_fe2_s{sample_fname}_handcraft_{sample_num}.npy")
            fname_spec = os.path.join(spec_cachedir, f"afpid_fe2_s{sample_fname}_spectrogram_{sample_num}.npy")
            sample_num += 1
...
train_df.to_csv(os.path.join(afpid_dataset_dir, 'AFPID_FE2_train.csv'))
test_df.to_csv(os.path.join(afpid_dataset_dir, 'AFPID_FE2_test.csv'))

print("Finished to create the AFPID_FE2 dataset with two consecutive footstep events to form on sample!")

...
afpid_dataset_dir = "../data/acoustic_footstep/AFPID_W7"
...
for i in range(13):
    ...
    for j in range(len(audio_dir)):
        ...
        while end_indx+fixed_sample_len <= ended_indx:
            ...
            fname_wave = os.path.join(wave_cachedir, f"afpid_w7_s{sample_fname}_waveform_{sample_num}.npy")
            fname_hcraft = os.path.join(hcraft_cachedir, f"afpid_w7_s{sample_fname}_handcraft_{sample_num}.npy")
            fname_spec = os.path.join(spec_cachedir, f"afpid_w7_s{sample_fname}_spectrogram_{sample_num}.npy")
            sample_num += 1
...
train_df.to_csv(os.path.join(afpid_dataset_dir, 'AFPID_W7_train.csv'))
test_df.to_csv(os.path.join(afpid_dataset_dir, 'AFPID_W7_test.csv'))

print("Finished to create the AFPID_W7 dataset with two consecutive footstep events to form on sample!")
